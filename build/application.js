...
var _lightersList = __webpack_require__(329);

__webpack_require__(333);

var lamps = new _lightersList.LightersList('.lamps');
window.lamps = lamps;
...
exports.LightersList = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _lighter = __webpack_require__(330);

__webpack_require__(332);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var LightersList = function () {
    function LightersList(cssSelector) {
        _classCallCheck(this, LightersList);
    ...
    _createClass(LightersList, [{
        ...
        key: 'onLampToggleOn',
        value: function onLampToggleOn(lighter) {
            this.enabledLights.push(lighter);
            console.log(lighter, this.enabledLights);
        }
    }, {
        key: 'onLampToggleOff',
        value: function onLampToggleOff(lighter) {
            var replaceLights = [];
            ...
            try {
                for (var _iterator = this.enabledLights[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        value: function addLamp() {
            var lighter = new _lighter.Lighter(this.list, this.onLampToggleOn.bind(this), this.onLampToggleOff.bind(this));
            this.lights.push(lighter);
        }
    }, {
        key: 'removeLamp',
        value: function removeLamp() {
            var lighter = this.lights.pop();
            lighter.destroy();
        }
    }, {
        key: 'toggleAll',
        value: function toggleAll() {
            if (this.enabledLights.length > 0) {
                this.lights.forEach(function (lighter) {
                    lighter.toggleOff();
                });
            } else {
                this.lights.forEach(function (lighter) {
        ...
        key: 'toggleOnLight',
        value: function toggleOnLight(light) {
            light.toggleOn();
        }
    }, {
        key: 'toggleOffLight',
        value: function toggleOffLight() {
            this.enabledLights.forEach(function (lamp) {
                lamp.toggleOff();
            });
        }
    }, {
...
exports.LightersList = LightersList;
...
var Lighter = function () {
    ...
    function Lighter(parentElement, toggleOnHandler, toggleOffHandler) {
